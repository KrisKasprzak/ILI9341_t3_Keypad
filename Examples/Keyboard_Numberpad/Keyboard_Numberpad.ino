...
#define TEST Wingdings  // font for keypad buttons
int BtnX = 0, BtnY = 0;
int i = 0;
...
while(1){}
  ...
  PasswordInput.init(ILI9341_BLACK, ILI9341_WHITE, ILI9341_BLUE, ILI9341_NAVY, ILI9341_WHITE, ILI9341_CYAN, FONT_BUTTON);
  ...
  MyNumberPad.init(ILI9341_BLACK, ILI9341_WHITE, ILI9341_BLUE, ILI9341_NAVY, ILI9341_WHITE, ILI9341_CYAN, FONT_BUTTON);
  // optional methods
